...
3. Confirm `api/v1.txt`, shared protocol fixtures, the remote entry, feature manifests, lock schema, and compatibility policy changed only by deliberate review.
